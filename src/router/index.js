...
export const constantRoutes = [
  ...
  // 订单管理
  {
    ...
    children: [
      ...
      {
        path: 'orderyd',
        component: () => import('@/views/order/yd'),
        name: 'orderyd',
        meta: { title: '运单列表', icon: 'dashboard', affix: true }
      },
      {
        path: 'orderbatch',
    ...
    children: [
      {
        ...
        name: 'overview',
        meta: { title: '店铺总览', icon: 'dashboard', affix: true }
      }
    ]
  },
  // 统计报表
  {
    ...
    children: [
      {
        path: 'statisticsyd',
        component: () => import('@/views/statistics/yd'),
        name: 'statisticsyd',
        meta: { title: '运单签收统计', icon: 'dashboard', affix: true }
      },
      {
        path: 'statisticsydyc',
